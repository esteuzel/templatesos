<div class="home_app">
    <div class="container-fluid">
        <div class="row">            
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 noppading fondogris">
                ...
                <div class="cesvi-bottom"><p>El profesionalismo de quien conduce debe actuar analizando cada estímulo proporcionado por su entorno. En este punto es donde ingresa el aporte de las capacitaciones... en entender por qué debe ser un profesional de la conducción.  Es por eso que Cesvi Argentina brinda capacitaciones al personal SOS.</p><div class="logocesvi"><img src="images/logocesvi.png"></div></div>
                ...
                <div class="trabaja">
                    ...
                    <div class="trabaje_boton_masinfo">
                        <div class="trabaja_masinfo boton_masinfo trabaje_masinfo">
                            <a href="dejar-cv.html">DEJAR CV</a>
                        </div>
                    </div>    
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 noppading">
                <div class="sos-sustentable-imagen">
        ...
        <img class="home_app_celular" src="images/sos-aplicacion-celular.png">
    </div>
</div>
